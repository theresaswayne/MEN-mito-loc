# compare_thresholds_by_SD.R
# assessing threshold quality by measured pixel data 
...
raw_mito_intden <- all_mito %>%
  summarise(RawMitoMean = sum(`Mean (roGFP 470 (DCI: 60 its, roGFP 470))`*`Volume (µm³)`)/sum(`Volume (µm³)`),
